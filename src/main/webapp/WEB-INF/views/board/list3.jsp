				...
				<div id="list">
					<form action="${pageContext.request.contextPath}/board/list">
						<div class="form-group text-right">
							<input type="text" name="selectPage" value="1" hidden> <input type="text" name="keyword">
					...
					<div id="paging">
						<ul>
							...
							<li><a href="${pageContext.request.contextPath}/board/listPaging?page=${page}">${page}</a></li>
							</c:forEach>
