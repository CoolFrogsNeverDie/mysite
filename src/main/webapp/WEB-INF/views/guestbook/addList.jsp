...
<body>
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="guestbook">
				<form action="../Guestbook/guestbookWrite" method="">
					<table id="guestAdd">
						<colgroup>
						...
						<tbody>
							<tr>
								...
								<td><input id="input-uname" type="text" name="author" required></td>
				...
				<table class="guestRead">
					...
					<tr>
						...
						<td><a href="../Guestbook/guestbookDeleteForm/${guestbook.num}">[삭제]</a></td>
					</tr>
					<tr>
